      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 lg:py-16">
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-fade-in">
              ...
              <div className="flex justify-center mb-8 sm:mb-12">
                <a 
                  href="#contact-form"
                  className="bg-saas-orange hover:bg-orange-600 text-white font-semibold py-3 px-8 sm:px-10 rounded-lg transition-all duration-200 text-sm sm:text-base inline-flex items-center justify-center"
                >
                  Get Unfazed Today
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-16 sm:mb-24 md:mb-32 lg:mb-40">
                <div className="flex -space-x-2 sm:-space-x-3">
                  ...
                  />
                  <img 
                    src="https://randomuser.me/api/portraits/med/women/68.jpg" 
          ...
          <div className="w-full max-w-6xl mx-auto px-2 sm:px-4 py-8 md:py-16 relative z-10">
            ...
            <div className="relative overflow-x-auto">
              ...
              <div className="hidden md:grid grid-cols-12 bg-saas-black/80 border-b border-gray-800">
                <div className="col-span-6 p-4 md:p-6 flex items-center justify-center">
                  <h3 className="text-base md:text-lg font-bold text-white">Metric</h3>
                </div>
                <div className="col-span-3 p-4 md:p-6 text-center border-l border-gray-700">
                  <h3 className="text-base md:text-lg font-bold text-white">Your Way</h3>
                </div>
                <div className="col-span-3 p-4 md:p-6 text-center bg-saas-orange/10">
              ...
              <div className="md:hidden grid grid-cols-12 bg-saas-black/80 border-b border-gray-800">
                <div className="col-span-8 p-4 border-r border-gray-700 text-center">
                  <h3 className="text-base font-bold text-gray-200">Metric</h3>
                </div>
              ...
              {[
                ...
                <React.Fragment key={index}>
                  ...
                  <div className="hidden md:grid grid-cols-12 group hover:bg-saas-black/40 transition-colors">
                    <div className="col-span-6 p-3 md:p-4 flex items-center">
                    ...
                    <div className="col-span-3 p-3 md:p-4 flex items-center justify-center border-l border-gray-700">
                      <span className="text-xs sm:text-sm md:text-base text-gray-300">{item.traditional}</span>
                    </div>
                    <div className="col-span-3 p-3 md:p-4 flex items-center justify-center bg-saas-orange/5 border-l border-gray-700">
          ...
          <div id="services-section" className="w-full max-w-[2000px] mx-auto px-3 sm:px-4 py-12 md:py-16 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 max-w-[2000px] mx-auto">
              {/* Lead Generation Card */}
              <div className="glowing-border bg-saas-black/50 backdrop-blur-sm rounded-lg md:rounded-xl p-3 sm:p-4 border border-gray-800 hover:border-saas-orange/50 transition-colors h-full flex flex-col items-center">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-md bg-saas-orange/10 flex items-center justify-center mb-2 sm:mb-3">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-saas-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="glowing-border md:col-span-2 bg-saas-black/50 backdrop-blur-sm rounded-lg md:rounded-xl p-3 sm:p-4 md:p-6 border border-gray-800 transition-colors w-full">
                  ...
                  <div className="space-y-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4">
                    ...
                    <div className="relative pl-10 sm:pl-0">
                      <div className="flex items-center mb-1 sm:mb-2">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-saas-orange/10 flex items-center justify-center mr-2">
                          <span className="text-saas-orange font-bold text-xs sm:text-sm">1</span>
                        </div>
                    ...
                    <div className="relative pl-10 sm:pl-0">
                      <div className="flex items-center mb-1 sm:mb-2">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-saas-orange/10 flex items-center justify-center mr-2">
                          <span className="text-saas-orange font-bold text-xs sm:text-sm">2</span>
                        </div>
                    ...
                    <div className="relative pl-10 sm:pl-0">
                      <div className="flex items-center mb-1 sm:mb-2">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-saas-orange/10 flex items-center justify-center mr-2">
                          <span className="text-saas-orange font-bold text-xs sm:text-sm">3</span>
                        </div>
